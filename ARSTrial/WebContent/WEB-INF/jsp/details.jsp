...
<form:form method="POST" action="details">
             <table>
                ...
                <tr>
                	<td>Age Group : </td>
                	 <td> 
                	 <form:radiobutton path="ageGroup" value="Adult" label="Adult" /> 
            		 <form:radiobutton path="ageGroup" value="Child" label="Child" />
            		 <form:radiobutton path="ageGroup" value="Infant" label="Infant" />
                	</td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                	<td>ID Type : </td>
                	 <td> 
                	 <form:radiobutton path="idType" value="Passport" label="Passport" /> 
            		 <form:radiobutton path="idType" value="Aadhar_Card" label="Aadhaar Card" />
      				</td>
                </tr>
                <tr>
                   <td>ID No. : </td>
